...
//	    driver = new ChromeDriver();
	...
	public void testCase1() {
		...
		String forgetHeader = driver
				.findElement(By.xpath("//p[@class='oxd-text oxd-text--p orangehrm-login-forgot-header']")).getText();
	...
	public void testCase2() {
		...
		boolean linkedHeader = driver.findElement(By.xpath("//div[@class='orangehrm-login-footer-sm']//a[1]"))
				.isDisplayed();
		Assert.assertEquals(true, linkedHeader);
		System.out.print(linkedHeader);

		boolean fbHeader = driver.findElement(By.xpath("//div[@class='orangehrm-login-footer-sm']//a[2]"))
				.isDisplayed();
		Assert.assertEquals(true, fbHeader);
		System.out.print(fbHeader);

		boolean twitterHeader = driver.findElement(By.xpath("//div[@class='orangehrm-login-footer-sm']//a[3]"))
				.isDisplayed();
		Assert.assertEquals(true, twitterHeader);
		System.out.print(twitterHeader);

		boolean utubeHeader = driver.findElement(By.xpath("//div[@class='orangehrm-login-footer-sm']//a[4]"))
				.isDisplayed();
		Assert.assertEquals(true, utubeHeader);
		System.out.print(utubeHeader);

		boolean orangeHeader = driver.findElement(By.xpath("//div[@class='orangehrm-copyright-wrapper']//p[1]"))
				.isDisplayed();
		Assert.assertEquals(true, orangeHeader);
		System.out.println(orangeHeader);

		boolean orangeHeader2 = driver.findElement(By.xpath("//div[@class='orangehrm-copyright-wrapper']//p[2]"))
				.isDisplayed();
	...
	public void close() throws IOException {
		...
		FileUtils.copyFile(file, new File("C:\\Users\\91969\\Desktop\\TakeScreenshot" + ++increement + ".png"));
